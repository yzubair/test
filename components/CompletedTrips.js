...
export default class CompletedTrips extends React.Component {
  render() {
    return (
...
{/* Hooking History*/}
 ...
 <View style={styles.touchableBox}>
              <TouchableOpacity style={styles.touch1}>
                <Text style={styles.touchableSelected}>Completed</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.touch2}  
               onPress={() => {
                this.props.navigation.navigate("Cancelled Trips");
               }}
               >
                <Text style={styles.touchableTextTop}>Cancelled</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.touch2} >
              {/* onPress={() => {
...
<View >
          <View style={{flexDirection:"row", alignItems:"center"}}>
            <Text style={styles.tripText}>Islamabad</Text>
...
<Icon name= {"ios-airplane"} size={25} color="black" style={{marginTop:3,}}></Icon>
            <Text style={styles.tripText}>London</Text>
          </View>
